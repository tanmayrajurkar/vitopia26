...
export default function AboutSection() {
    return (
        <section className="py-12 md:py-20 bg-[#050505] relative overflow-hidden border-y border-white/10">
            {/* Background Grid */}
            ...
            <div className="container mx-auto px-6 relative z-10">
                ...
                >
                    <h2 className="text-3xl md:text-5xl lg:text-6xl font-anton text-white uppercase mb-3 leading-none">
                    ...
                    <p className="text-gray-400 font-outfit text-sm md:text-lg max-w-2xl mx-auto">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-12 items-center max-w-7xl mx-auto">
                    ...
                    >
                        {/* VITOPIA '24 Card */}
                        <div className="group">
                            <div className="border-l-4 border-lime-400 pl-4 md:pl-5 py-3 bg-gradient-to-r from-lime-400/5 to-transparent hover:from-lime-400/10 transition-all duration-300">
                        ...
                        {/* VIT-AP Card */}
                        <div className="group">
                            <div className="border-l-4 border-purple-500 pl-4 md:pl-5 py-3 bg-gradient-to-r from-purple-500/5 to-transparent hover:from-purple-500/10 transition-all duration-300">
                                <h3 className="text-xl md:text-2xl lg:text-3xl font-anton text-white mb-3 uppercase flex items-center gap-2">
                                    VIT-AP
                        ...
                        <div className="grid grid-cols-3 gap-3 pt-3">
                            <div className="text-center p-2 md:p-3 bg-white/5 backdrop-blur-sm border border-white/10 rounded-lg">
                                <div className="text-xl md:text-3xl font-anton text-lime-400 mb-1">17K+</div>
                                <div className="text-[10px] md:text-sm text-gray-400 font-outfit uppercase tracking-wider">Students</div>
                            </div>
                            <div className="text-center p-2 md:p-4 bg-white/5 backdrop-blur-sm border border-white/10 rounded-lg">
                                <div className="text-xl md:text-3xl font-anton text-purple-400 mb-1">200</div>
                                <div className="text-[10px] md:text-sm text-gray-400 font-outfit uppercase tracking-wider">Acres</div>
                            </div>
                            <div className="text-center p-2 md:p-4 bg-white/5 backdrop-blur-sm border border-white/10 rounded-lg">
                                <div className="text-xl md:text-3xl font-anton text-pink-400 mb-1">#1</div>
                                <div className="text-[10px] md:text-sm text-gray-400 font-outfit uppercase tracking-wider">Ranked</div>
                            </div>
                        </div>
                    </motion.div>
                    ...
                    {/* Enhanced Image Grid */}
                    <motion.div
                        className="relative h-[320px] md:h-[480px] w-full"
                        initial={{ opacity: 0, x: 30 }}
                        whileInView={{ opacity: 1, x: 0 }}
                        viewport={{ once: true, amount: 0.2 }}
                        transition={{ duration: 0.6 }}
                    >
                        ...
                        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-20">
                            <div className="relative w-20 h-20 md:w-32 md:h-32 border-2 border-white/30 rounded-full flex items-center justify-center backdrop-blur-xl bg-black/40 shadow-[0_0_40px_rgba(190,242,100,0.3)] group hover:border-lime-400 hover:shadow-[0_0_60px_rgba(190,242,100,0.5)] transition-all duration-300">
                                <div className="text-center">
                                    <div className="font-anton text-3xl md:text-5xl text-transparent bg-clip-text bg-gradient-to-b from-lime-400 to-green-400 mb-1">
                                        26
                                    </div>
